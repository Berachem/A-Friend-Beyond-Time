...
class StartButton(arcade.gui.UIFlatButton):
    ...
    def on_click(self, event: arcade.gui.UIOnClickEvent):
        ...
        game_view = GameView()
        game_view.setup()
        # Use the view's window to switch to the game view
...
class StartView(arcade.View):
    def __init__(self):
        ...
        # Button Start
        start_button = StartButton(view=self, text="Start Game", width=200)
...
class GameOverView(arcade.View):
    ...
    def __init__(self):
        ...
        restart_button = StartButton(view=self, text="Restart Game", width=200)
